...
var Client = function Client() {
    if (arguments.length === 0) throw new Error('an array of BASE_URL, ACCESS_KEY, SECRET_KEY, USER is required');
...
Client.prototype.generateJWT = function () {
    ...
    if (arguments.length === 0) throw new Error('an array of METHOD, URI, JWT_EXPIRE is required');
    ...
    if (QUERY_STRING) CANONICAL_PATH = arguments[0] + '&' + RELATIVE_PATH + '&' + QUERY_STRING;else CANONICAL_PATH = arguments[0] + '&' + RELATIVE_PATH + '&';
    ...
    var token = jwt.encode(jwtPayload, self.SECRET_KEY);
